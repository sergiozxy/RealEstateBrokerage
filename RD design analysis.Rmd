...
unrelated_result <- rdrobust(y = panel_data$ln_negotiation_period, 
                             x = panel_data$nearest_store_distances, c = 0.41, h = 0.066, b = 0.135)
print("Placebo test with unrelated outcome:")
print(unrelated_result)
pander(cbind(unrelated_result$coef, unrelated_result$pv))
```
