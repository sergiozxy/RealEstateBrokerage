...
global dependent_variable yearx1_density yearx2_density yearx3_density yearx4_density yearx5_density yearx6_density yearx7_density
...
xtabond2 L(0/1)price_concession $dependent_variable broker_420 ln_watch_people $brokerage_control $Lag_hedonic_control $transaction_control $region_control i.year,  ///
gmmstyle(L.price_concession $dependent_variable L.ln_negotiation_period floor_level total_building L.house_age, equation(diff) lag(1 2) collapse) ///
ivstyle( broker_420 ln_watch_people non_online_effect ln_watch_time ln_nego_changes  area bedroom toilet  green_ratio total_floor_number living_room elevator_ratio kitchen floor_ratio total_resident jiadian_hedonic_lag kind_hedonic_lag hotel_hedonic_lag shop_mall_hedonic_lag museum_hedonic_lag old_hedonic_lag ktv_hedonic_lag mid_hedonic_lag prim_hedonic_lag west_food_hedonic_lag super_hedonic_lag sub_hedonic_lag park_hedonic_lag pm25 pop light i.year, equation(diff)) noconstant twostep nolevel cluster(bs_code) 
