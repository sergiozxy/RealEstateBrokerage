...
We decided to use the so called quantile estimator proposed by \citep{https://doi.org/10.1111/j.1468-0262.2006.00668.x}. The CIC model does not assume that the 
...
The table shown in the Table \ref{tab:network_clustering_effect} shows the 
