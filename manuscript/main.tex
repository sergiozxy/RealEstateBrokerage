...
Our model is in line with the real world setting that the sellers are hard to predict which platform can bring how many buyers to their house but the buyers can search all the information available online to decide which house they are interersted in.
