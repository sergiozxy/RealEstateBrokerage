...
In the Appendix Table \ref{tab:sylized_fact_hetero_hhi} we also report the results of the robustness check of the dynamic model. The results show that the dynamic model Table \ref{tab:sylized_fact_hetero_mature}
