...
\title{ \vspace*{-2.5cm} \hspace*{-0.5cm}Evaluating the Impact of Offline Store Clusters under the Consolidation: Evidence from China's Metropolitan Real Estate Market \footnote{
...
% Brokerage consolidation refers to the process by which a larger real estate brokerage firm integrates multiple smaller brokerage firms into a single, unified platform.
