...
% here is my question using rigorous mathematical model and mathematical framework to:

% now formulate the assumption that other store's brokerage are homogenous and the brokerage $1$'s network effect is greater than other bokerage.

% now give me the first proposition that in equilibrium, the number of brokerage $1$'s share in the market is greater than the number of brokerage $1$'s proportion of number of stores. Besides, the brokerage $1$'s optimal choice of broekrage charge is greater than other brokerage 
...
Now we derive the cosumer surplus, which is:
