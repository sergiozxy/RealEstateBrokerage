...
We decided to use the so called Change-in-Change (CIC) estimator proposed by \citep{https://doi.org/10.1111/j.1468-0262.2006.00668.x}. The CIC model does not assume that the 
