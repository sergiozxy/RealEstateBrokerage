...
\begin{figure}[ht]
  \centering
  \subfloat[Placebo Test to transaction number]{\includegraphics[width=0.5\textwidth]{../figures/placebo_results/placebo_entry_num.pdf}\label{fig:placebo_num_entry}}
  \subfloat[Placebo Test to number of house tours]{\includegraphics[width=0.5\textwidth]{../figures/placebo_results/placebo_entry_lead.pdf}\label{fig:placebo_lead_entry}}
  \hfill % Adds horizontal space between figures
  \subfloat[Placebo Test to transaction period]{\includegraphics[width=0.5\textwidth]{../figures/placebo_results/placebo_entry_period.pdf}\label{fig:placebo_period_entry}}
  \subfloat[Placebo Test to price concession]{\includegraphics[width=0.5\textwidth]{../figures/placebo_results/placebo_entry_concession.pdf}\label{fig:placebo_concession_entry}}
...
\begin{figure}[ht]
  \centering
  \subfloat[Placebo Test to transaction number]{\includegraphics[width=0.5\textwidth]{../figures/placebo_results/placebo_plat_num.pdf}\label{fig:placebo_num_plat}}
  \subfloat[Placebo Test to number of house tours]{\includegraphics[width=0.5\textwidth]{../figures/placebo_results/placebo_plat_lead.pdf}\label{fig:placebo_lead_plat}}
  \hfill % Adds horizontal space between figures
  \subfloat[Placebo Test to transaction period]{\includegraphics[width=0.5\textwidth]{../figures/placebo_results/placebo_plat_period.pdf}\label{fig:placebo_period_plat}}
  \subfloat[Placebo Test to price concession]{\includegraphics[width=0.5\textwidth]{../figures/placebo_results/placebo_plat_concession.pdf}\label{fig:placebo_concession_plat}}
...
\begin{table}[H]
  \caption{Other Meausre Indices of the Network Effect}
  \label{other:measures}
  \input{../result_tables/other_indices_appendix.tex}
\end{table}
