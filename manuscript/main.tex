...
Through the success of the platform consolidation, Lianjia transforms internal competition within the system into overall system competitiveness, thereby enhancing the brand's reputation and market influence. More importantly, this strategic allows Lianjia to cooperate with other previously competitors by consolidating resources. According to the IPO prospectus by Beke, the market share of Lianjia is around 20.8\% in year 2020 in China's second hand housing market and the number of stores share in the whole China is less than 5\% according to the AutoNavi map and moreover, in large cities like Chengdu, Beijing and Shanghai, the second hand housing share of Lianjia is even larger to 

This remarkable market penetration underscores the efficacy of Beke's integrated platform and ACN model in dominating the real estate brokerage landscape. The Figure \ref{fig:precise_proportion_contraction} shows the comparision of the market share of Lianjia and the share of the number of stores in the market. [NEED TO ADD A FIGURE OR TABLE]
