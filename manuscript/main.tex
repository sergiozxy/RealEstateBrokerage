...
\textbf{Now I think about how to do this, the first task is to write completely the model and estimation of the offline and platform's effect with offline is the brokerage's offline store's entry and the onlien is the platofmrization strategy.}
